    ...
    <div className="scene" style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column' }}>
      ...
      <style>{`
        @media (orientation: landscape) and (max-width: 900px) and (max-height: 500px) {
          .sw-content { flex-direction: row !important; align-items: flex-start !important; gap: 24px; padding: 16px 24px !important; overflow: hidden !important; }
          .sw-left { flex: 0 0 220px; overflow: hidden; }
          .sw-hero { margin-bottom: 0 !important; }
          .sw-hero h1 { font-size: 20px !important; }
          .sw-hero p { display: none; }
          .sw-right { flex: 1; min-width: 0; display: flex; flex-direction: column; overflow-y: auto; max-height: calc(100dvh - 32px); }
          .sw-suggestions { margin-bottom: 12px !important; }
        }
      `}</style>
      <div className="scene-content sw-content" style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '56px 20px 24px', overflowY: 'auto' }}>
        ...
        <div className="sw-left">
          ...
          {/* Icon + hero */}
          <div className="sw-hero" style={{ textAlign: 'center', marginBottom: 32 }}>
        ...
        <div className="sw-right">
          ...
          {!submitted ? (
            <>
              ...
              {/* Suggestions */}
              <div className="sw-suggestions" style={{ marginBottom: 32 }}>
